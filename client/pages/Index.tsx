        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 perspective-1000">
            <AnimatedSection animation="scaleIn" delay={0}>
              <Card
                className="text-center p-8 hover:shadow-2xl transition-all duration-700 hover:-translate-y-6 hover:rotate-2 hover:scale-105 bg-gradient-to-br from-white to-primary/5 group relative overflow-hidden transform-gpu"
                style={{
                  transformStyle: "preserve-3d",
                  transition:
                    "all 0.7s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
              ...
              >
                <CardContent className="pt-6 relative z-10">
                  ...
                  <h3 className="text-4xl font-bold text-foreground mb-3 group-hover:text-primary transition-colors duration-300">
                    100%
                  </h3>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Data-driven strategies that deliver clear ROI
                  </p>
                </CardContent>
            ...
            <AnimatedSection animation="scaleIn" delay={200}>
              <Card
                className="text-center p-8 hover:shadow-2xl transition-all duration-700 hover:-translate-y-6 hover:-rotate-1 hover:scale-105 bg-gradient-to-br from-white to-secondary/5 group relative overflow-hidden transform-gpu"
                style={{
                  transformStyle: "preserve-3d",
                  transition:
                    "all 0.7s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
              ...
              >
                <CardContent className="pt-6 relative z-10">
                  ...
                  <h3 className="text-4xl font-bold text-foreground mb-3 group-hover:text-secondary transition-colors duration-300">
                    24/7
                  </h3>
                  <p className="text-xl text-muted-foreground group-hover:text-foreground transition-colors duration-300">
                    Innovation First
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Cutting-edge solutions that keep you ahead
                  </p>
                </CardContent>
            ...
            <AnimatedSection animation="scaleIn" delay={400}>
              <Card
                className="text-center p-8 hover:shadow-2xl transition-all duration-700 hover:-translate-y-6 hover:rotate-1 hover:scale-105 bg-gradient-to-br from-white to-accent/5 group relative overflow-hidden transform-gpu"
                style={{
                  transformStyle: "preserve-3d",
                  transition:
                    "all 0.7s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
              ...
              >
                <CardContent className="pt-6 relative z-10">
                  ...
                  <h3 className="text-4xl font-bold text-foreground mb-3 group-hover:text-accent transition-colors duration-300">
                    50+
                  </h3>
                  <p className="text-xl text-muted-foreground group-hover:text-foreground transition-colors duration-300">
                    Trusted Partners
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Long-term relationships built on excellence
                  </p>
                </CardContent>
          ...
          <AnimatedSection animation="slideUp">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                We combine creative excellence with technological innovation to
              ...
              <div className="group">
                <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-3xl p-8 h-full hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                    Strategic marketing campaigns, brand development, and
                    creative content that builds authentic connections with your
                    audience.
                  </p>
            ...
            <AnimatedSection animation="slideRight" delay={400}>
              <div className="group">
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl p-8 h-full hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                    Innovative tech solutions, AI automation, and digital
                    transformation strategies that streamline your operations.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
              ...
              <Card className="p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-muted/30">
                <CardContent className="pt-6">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 italic">
                    "Lapeng Synegy transformed our digital presence completely.
                    Their integrated approach to marketing and technology
            ...
            <AnimatedSection animation="slideUp" delay={200}>
              <Card className="p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-muted/30">
                <CardContent className="pt-6">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 italic">
                    "Working with Lapeng Synegy has been a game-changer. Their
                    AI solutions streamlined our operations and increased
                    efficiency by 40%."
                  </p>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center mr-4">
            ...
            <AnimatedSection animation="slideUp" delay={400}>
              <Card className="p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-muted/30">
                <CardContent className="pt-6">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 italic">
                    "The team's expertise in brand development helped us
                    establish a strong market presence. Our brand recognition
                    increased by 200%."
                  </p>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Marketing Manager, StyleHub Boutique
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <AnimatedSection animation="slideUp" delay={600}>
              <Card className="p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-muted/30">
                <CardContent className="pt-6">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 italic">
                    "Outstanding virtual assistant services! They managed our
                    social media campaigns flawlessly and increased our
                    engagement by 300%."
                  </p>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center mr-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <AnimatedSection animation="slideUp">
            ...
            <p className="text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
              Join successful businesses who trust Lapeng Synegy to bridge the
